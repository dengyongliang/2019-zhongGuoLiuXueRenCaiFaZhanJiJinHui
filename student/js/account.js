...
$(function() {
    ...
    $page.delegate(".update", "click", function(e) {
        var $this = $(this);
        $this.closest(".row").find("input").show().siblings(".text").hide();
    ...
    $page.delegate(".updateMobile", "click", function(e) {
        var $this = $(this);
        $this.closest(".row").find("input,button").show().siblings(".text").hide();
        $this.hide().siblings().show();
    });
    
    $page.delegate(".cancle", "click", function(e) {
        var $this = $(this);
        $this.closest(".row").find("input").hide().siblings().show();
        $this.hide().siblings(".save").hide().siblings(".update").show();
    });
    $page.delegate(".cancleMobile", "click", function(e) {
        var $this = $(this);
        $this.closest(".row").find("input,button").hide().siblings(".text").show();
